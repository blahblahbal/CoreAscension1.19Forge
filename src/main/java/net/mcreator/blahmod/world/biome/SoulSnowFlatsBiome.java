...
public class SoulSnowFlatsBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-1).waterColor(-16762881).waterFogColor(-16762881).skyColor(-1)
