...
import net.mcreator.blahmod.procedures.GildedObsidianArmorProcedure;
import net.mcreator.blahmod.init.BlahmodModTabs;
import net.mcreator.blahmod.init.BlahmodModItems;
import net.minecraft.world.entity.LivingEntity;

public abstract class GildedObsidianItem extends ArmorItem {
	public GildedObsidianItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends GildedObsidianItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "blahmod:textures/models/armor/gilded_obsidian____layer_1.png";
		}
	}

	public static class Chestplate extends GildedObsidianItem {
		public Chestplate() {
		...
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			GildedObsidianArmorProcedure.execute(entity);
		}
	}

	public static class Leggings extends GildedObsidianItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "blahmod:textures/models/armor/gilded_obsidian____layer_2.png";
		}
	}

	public static class Boots extends GildedObsidianItem {
		public Boots() {
